...
#undef C2_JVMTI_STUB_FIELD_DECLARE
  ...
  static const TypeFunc *_digestBase_implCompress_tf;
  static const TypeFunc *_digestBase_implCompressMB_tf;
...
private:
 ...
 public:
  ...
  static void new_array_nozero_Type_init ();   // [a]newarray (slow case)
  static void multianewarray_Type_init(int ndim); // multianewarray
  ...
  static void digestBase_implCompress_Type_init(bool is_sha3);
  static void digestBase_implCompressMB_Type_init(bool is_sha3);
