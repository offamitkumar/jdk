...
class MacroAssembler: public Assembler {
 ...
 public:
  ...
  void compiler_fast_lock_lightweight_object(Register box, Register obj, Register tmp1, Register tmp2);
  void compiler_fast_unlock_lightweight_object(Register box, Register obj, Register tmp1, Register tmp2);
