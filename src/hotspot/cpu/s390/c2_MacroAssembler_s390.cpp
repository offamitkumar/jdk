...
void C2_MacroAssembler::fast_lock_lightweight(Register oop, Register box, Register temp1, Register temp2) {
  compiler_fast_lock_lightweight_object(oop, temp1, temp2);
}


void C2_MacroAssembler::fast_unlock_lightweight(Register oop, Register box, Register temp1, Register temp2) {
