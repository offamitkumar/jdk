...
//   cnt is signed int. Do not rely on high word!
//       counts # characters, not bytes.
unsigned int C2_MacroAssembler::string_inflate(Register src, Register dst, Register cnt, Register tmp, VectorRegister v20, VectorRegister v21,
...
unsigned int C2_MacroAssembler::string_inflate_const(Register src, Register dst, Register tmp, int len, VectorRegister v20, VectorRegister v21,
                                                     VectorRegister v22, VectorRegister v23, VectorRegister v24, VectorRegister v25) {
